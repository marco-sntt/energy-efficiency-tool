...
with st.form("intervention_form"):
    ...
    labels = {
        ...
        2: "2 – Miglioramento involucro trasparente",
        3: "3 – Sostituzione/upgrade impianto riscaldamento",
        4: "4 – Sostituzione/upgrade impianto raffrescamento",
        5: "5 – Uso di fonti rinnovabili",
